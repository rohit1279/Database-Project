<%@ Page Title="Players" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PlayersPage.aspx.cs" Inherits="Sports_Website.Agents.PlayersPage" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <div style="font-size:50px; text-align:center;">
    ...
    <div class="row" style="text-align:center;">
        <div class="col-md-15">
            <asp:Button ID="Players" runat="server" Text="Players" Height="100px" Width="200px" Font-Size="25px" BorderColor="#000000" Enabled="false" CssClass="PlayersButton"/>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
