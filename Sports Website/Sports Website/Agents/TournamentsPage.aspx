<%@ Page Title="Tournaments" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TournamentsPage.aspx.cs" Inherits="Sports_Website.Agents.TournamentsPage" %>
  ...
  <div style="font-size:50px; text-align:center;">
    ...
    <div class="row" style="text-align:center;">
        <div class="col-md-15">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Tournaments" runat="server" Text="Tournaments" Height="100px" Width="200px" Font-Size="25px" BorderColor="#000000" Enabled="false" CssClass="TournamentsButton"/>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
