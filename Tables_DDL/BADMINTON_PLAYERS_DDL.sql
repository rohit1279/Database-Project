CREATE TABLE "DB626"."BADMINTON_PLAYERS" 
   (	"ID" NUMBER NOT NULL ENABLE, 
	...
	"UPDATED_DT" TIMESTAMP (6), 
	 CONSTRAINT "BADMINTON_PLAYERS_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "STUDENTS"  ENABLE, 
	 CONSTRAINT "BADMINTON_PLAYERS_FK1" FOREIGN KEY ("CREATED_BY")
	  REFERENCES "DB626"."AGENTS" ("ID") ENABLE, 
	 CONSTRAINT "BADMINTON_PLAYERS_FK2" FOREIGN KEY ("UPDATED_BY")
	  REFERENCES "DB626"."AGENTS" ("ID") ENABLE, 
	 CONSTRAINT "BADMINTON_PLAYERS_FK3" FOREIGN KEY ("COUNTRY")
